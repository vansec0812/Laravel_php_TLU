    ...
    <div class="card-body">
        <form method="POST" action="{{ route('employees.update', $employee->Id) }}">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="date" name="Birthday" class="form-control" value="{{ old('Birthday', $employee->Birthday) }}"/>
                </div>
            </div>
            <div class="row mb-4">
                ...
                <div class="col-sm-10">
                    <select name="roomsId" class="form-control">
                        ...
                        @foreach($rooms as $room)
                            <option value="{{ $room->roomsId }}" {{ old('roomsId', $employee->roomsId) == $room->roomsId ? 'selected' : '' }}>
                                {{ $room->Name }}
                            </option>
                        @endforeach
                    </select>
